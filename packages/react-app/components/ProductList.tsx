...
const ProductList = () => {
  // Get current sort from the context
  const { currentSort } = useContext(UserContext) as IContextType;
    ...
    const getProducts = () => {
      ...
      // sort products from new to oldest product before it's returned
      if (currentSort === 'newest') {
        return products.sort((a , b) => Number(b.key) - Number(a.key))
      }
      return products;
    };
